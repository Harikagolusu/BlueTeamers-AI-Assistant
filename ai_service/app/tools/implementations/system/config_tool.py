...
from app.tools.domain.schemas.system_schemas import ConfigSchema
...
class ConfigTool(BaseTool):
    ...
    async def execute(self, request: ToolRequest) -> ToolResponse:
        try:
            schema = ValidationService.validate_schema(ConfigSchema, request.arguments)
            result = await self._service.get_config(schema)
