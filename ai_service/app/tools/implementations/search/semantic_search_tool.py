...
from app.tools.domain.schemas.search_schemas import SemanticSearchSchema
...
class SemanticSearchTool(BaseTool):
    ...
    async def execute(self, request: ToolRequest) -> ToolResponse:
        try:
            schema = ValidationService.validate_schema(SemanticSearchSchema, request.arguments)
            result = await self._service.semantic_search(schema)
