...
from app.tools.domain.schemas.cybersecurity_schemas import IpUtilitySchema
...
class IpUtilityTool(BaseTool):
    ...
    async def execute(self, request: ToolRequest) -> ToolResponse:
        try:
            schema = ValidationService.validate_schema(IpUtilitySchema, request.arguments)
            result = await self._service.get_ip_utility(schema)
