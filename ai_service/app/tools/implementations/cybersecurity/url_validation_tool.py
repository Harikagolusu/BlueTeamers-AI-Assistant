...
from app.tools.domain.schemas.cybersecurity_schemas import UrlValidationSchema
...
class UrlValidationTool(BaseTool):
    ...
    async def execute(self, request: ToolRequest) -> ToolResponse:
        try:
            schema = ValidationService.validate_schema(UrlValidationSchema, request.arguments)
            result = await self._service.validate_url(schema)
