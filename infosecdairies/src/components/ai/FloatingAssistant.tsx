              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={cn(
                        "bt-float-sm min-w-0 w-full max-w-full break-words [overflow-wrap:anywhere] overflow-hidden rounded-2xl border prose prose-zinc prose-invert prose-sm max-w-none",
                        msg.role === "user"
